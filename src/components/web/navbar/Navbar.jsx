  ...
  return (
    <nav className="navbar navbarColor navbar-expand-lg navbar-light py-0 mb-2">
      <div className="container">
        <a className="navbar-brand nav__logo " href="#">
          Lumière
        </a>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="d-flex list-inline gap-1 align-items-baseline">
            <li className="nav-item dropdown">
              <a
                className="dropdown-toggle text-decoration-none listdrop"
                href="#"
                role="button"
              ...
              {user ? (
                <div className="d-flex gap-2 align-items-baseline">
                  <div>
                    <Link to="/wishlist">
                      {" "}
                      <FaHeart color="black" fontSize={"1.3rem"} />{" "}
                    </Link>
                  </div>
                  <Link to="/cart" className=" position-relative">
                    <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger notiofication">
                      {cartCount}
                    </span>
                    <BsCart4 color="black" fontSize={"1.3rem"} />{" "}
                  </Link>
                </div>
              ) : (
                <Link to="/login">
                  <RiShoppingCart2Fill color="black" />{" "}
                </Link>
              )}
            </li>
          </ul>
