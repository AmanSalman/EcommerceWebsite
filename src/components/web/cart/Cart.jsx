					...
					<div className="cart-items">
						<div className="products" id="products">
...

                            {
                              ...
                              ): <h2 className=' text-success'>"the cart is empty"</h2> 
                            }
							{
							cartCount>=1?<div className='d-flex justify-content-center'>
							<Link className='btn btn-outline-info border w-25' to='/clearcart'> Clear </Link>	
						...
						<div className="cart-summary">
							...
							<div className="summery-items">
								...
								<div className="checkout">
									<Link to='/CreateOrder'>Check out</Link>
								</div>
							</div>
						</div>
